...
import { setSubject, updateSubject } from '../../redux/slice/items'
...
export default function SubjectUpdate({ element, setClose }: { element: ItemsType, setClose: React.Dispatch<SetStateAction<any>> }) {
    const dispatch = useDispatch()
    const [loadind, setLoading] = useState(false)
    const [subjectVal, setSubjectVal] = useState<ItemsType>(element)
    ...
    function handleSubmit(e: FormEvent<HTMLFormElement>) {
        ...
        axios.patch(`/subjects/${element.id}`, data, { headers: { 'Content-Type': 'application/json' } })
            .then(res => {
                setLoading(false)

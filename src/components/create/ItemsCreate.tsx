...
export default function ItemsCreate({ element, setClose }: { element?: UserType, setClose: React.Dispatch<SetStateAction<boolean>> }) {
    ...
    function handleSubmit(e: FormEvent<HTMLFormElement>) {
        ...
        axios.post('/subjects', data, { headers: { 'Content-Type': 'application/json' } })
            .then(res => {
                setLoading(false)
